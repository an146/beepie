...
let test_simple_notes () =
   ...
   let file = F.add_note tr (note ~channel 30 (0, 64) (100, 65)) file in
   let file = F.add_note tr (note ~channel 30 (300, 64) (400, 65)) file in
   let file = F.add_note tr (note ~channel 31 (1000, 64) (10000, 65)) file in
